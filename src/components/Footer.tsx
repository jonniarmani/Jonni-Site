...
import { Instagram, Video, Mail, Phone, Calendar } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="flex space-x-6">
              <a href={brand.socials.instagram} target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors">
                <Instagram size={24} />
              </a>
              <a href={brand.socials.vimeo} target="_blank" rel="noreferrer" className="hover:text-brand-gold transition-colors">
                <Video size={24} />
              </a>
            </div>
          </div>
